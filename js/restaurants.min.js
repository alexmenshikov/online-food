...
const restaurants=()=>{const restaurantsItems=document.querySelector(".restaurants__items");const modalAuth=document.querySelector(".modal");const renderItems=(data)=>{data.forEach((item)=>{const{image,kitchen,name,price,products,stars,time_of_delivery}=item;const a=document.createElement("a");a.setAttribute("href","/online-food/restaurant.html");a.classList.add("restaurants__card");a.dataset.product=products;a.innerHTML=`
